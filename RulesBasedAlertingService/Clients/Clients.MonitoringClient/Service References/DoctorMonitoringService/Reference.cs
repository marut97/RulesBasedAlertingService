...
namespace Clients.MonitoringClient.DoctorMonitoringService {
    ...
    public partial class PatientVitals : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private Clients.MonitoringClient.DoctorMonitoringService.Vitals[] VitalsField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public Clients.MonitoringClient.DoctorMonitoringService.Vitals[] Vitals {
            get {
    ...
    public partial class PatientAlert : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private Clients.MonitoringClient.DoctorMonitoringService.DeviceAlert[] CriticalAlertsField;
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private Clients.MonitoringClient.DoctorMonitoringService.DeviceAlert[] WarningAlertsField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public Clients.MonitoringClient.DoctorMonitoringService.DeviceAlert[] CriticalAlerts {
            get {
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public Clients.MonitoringClient.DoctorMonitoringService.DeviceAlert[] WarningAlerts {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="DoctorMonitoringService.IDoctorMonitoringService", CallbackContract=typeof(Clients.MonitoringClient.DoctorMonitoringService.IDoctorMonitoringServiceCallback), SessionMode=System.ServiceModel.SessionMode.Required)]
    public interface IDoctorMonitoringService {
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IDoctorMonitoringService/SubscribeToVitals", ReplyAction="http://tempuri.org/IDoctorMonitoringService/SubscribeToVitalsResponse")]
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IDoctorMonitoringService/UnsubscribeToVitals", ReplyAction="http://tempuri.org/IDoctorMonitoringService/UnsubscribeToVitalsResponse")]
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IDoctorMonitoringService/SubscribeToPatientAlerts", ReplyAction="http://tempuri.org/IDoctorMonitoringService/SubscribeToPatientAlertsResponse")]
        void SubscribeToPatientAlerts(string doctorId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IDoctorMonitoringService/SubscribeToPatientAlerts", ReplyAction="http://tempuri.org/IDoctorMonitoringService/SubscribeToPatientAlertsResponse")]
        System.Threading.Tasks.Task SubscribeToPatientAlertsAsync(string doctorId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IDoctorMonitoringService/UnsubscribeToPatientAlerts", ReplyAction="http://tempuri.org/IDoctorMonitoringService/UnsubscribeToPatientAlertsResponse")]
        ...
        Clients.MonitoringClient.DoctorMonitoringService.PatientVitals[] ReadPreviousVitals(string patientId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IDoctorMonitoringService/ReadPreviousVitals", ReplyAction="http://tempuri.org/IDoctorMonitoringService/ReadPreviousVitalsResponse")]
        System.Threading.Tasks.Task<Clients.MonitoringClient.DoctorMonitoringService.PatientVitals[]> ReadPreviousVitalsAsync(string patientId);
    }
    ...
    public interface IDoctorMonitoringServiceCallback {
        ...
        void ReceiveVitals(Clients.MonitoringClient.DoctorMonitoringService.PatientVitals vitals);
        ...
        void ReceiveAlerts(Clients.MonitoringClient.DoctorMonitoringService.PatientAlert alert);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IDoctorMonitoringServiceChannel : Clients.MonitoringClient.DoctorMonitoringService.IDoctorMonitoringService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class DoctorMonitoringServiceClient : System.ServiceModel.DuplexClientBase<Clients.MonitoringClient.DoctorMonitoringService.IDoctorMonitoringService>, Clients.MonitoringClient.DoctorMonitoringService.IDoctorMonitoringService {
        ...
        public Clients.MonitoringClient.DoctorMonitoringService.PatientVitals[] ReadPreviousVitals(string patientId) {
            return base.Channel.ReadPreviousVitals(patientId);
        }
        
        public System.Threading.Tasks.Task<Clients.MonitoringClient.DoctorMonitoringService.PatientVitals[]> ReadPreviousVitalsAsync(string patientId) {
